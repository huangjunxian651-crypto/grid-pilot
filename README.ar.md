...
الشبكة الأصلية تفتح المركز فور دخول السعر النطاق. GridPilot يعتمد **بناء المركز بالتتبّع**: يتتبّع القاع أولاً، ولا يدخل إلا بعد تأكيد الارتداد بنسبة 0.2% — لا يصطاد القاع عمياً، ولا يقف حارساً عند القمة. (لا يجري التتبّع إلا عند دخول السعر نافذة التفعيل في اتجاه الخسارة؛ أما إذا ارتد إلى النطاق من مستوى أعمق باتجاه جني الأرباح، فيُتخطّى التتبّع ويبدأ التشغيل مباشرةً.)

**السوق يتغيّر كل ثانية — فلماذا تعلّق أوامرك ولا تتحرك بعدها أبداً؟**
GridPilot يعيد اتخاذ القرار عند كل تحديث للسوق: يلغي ما يجب إلغاؤه، ويعدّل ما يجب تعديله، وقد لا توجد أي أمر معلّق على الدفتر في لحظةٍ ما؛ فعند السعر المواتي يطارد دفتر الأوامر ليثبّت السعر الأمثل، وعند السعر غير المواتي يفضّل أن يُفصَل كقاطعٍ آلي ويرفض الأمر — أمر Maker (0.02%) متى أمكن، ولا يدفع رسوم Taker (0.05%) عبثاً. هذه المطاردة لا تحمل أي مخاطرة هبوطية: إذا واصل السعر الانخفاض متجاوزاً سعر الشبكة، يطارده الروبوت ليشتري بسعر أرخص؛ وإذا ارتد دون كسر الخط الأعلى، يظل بإمكان الأمر أن يُنفَّذ بالسعر الأصلي — ووفق نموذج «إفلاس المقامر» (gambler's ruin) القياسي، فإن احتمال تفويت الصفقة فعلياً ضئيل جداً — فالربح الإضافي مجاني، وتفويته لا يكلف شيئاً.

**السعر يقفز 5–10 USDT دفعة واحدة — ماذا تستطيع شبكتك أن تفعل سوى التفرّج؟**
الأوامر الثابتة لا تصطاد إلا الأسعار الجامدة على خطوط الشبكة. GridPilot يبادر إلى التنفيذ النشط عندما يتجاوز انحراف السعر عن السعر النظري للشبكة العتبة (الافتراضية 0.1% ≈ 2× رسوم Taker، قابلة للضبط)، فيحبس في جيبه فرق القفزة الذي يتجاوز خطوة الشبكة — وقد أثبتت التجربة أنه كلما كانت دفاتر أوامر البورصة أكثر «خشونة»، زادت الأرباح الإضافية.
...
| **جودة التنفيذ** | الأوامر الثابتة لا تصطاد إلا أسعار خطوط الشبكة، ويمرّ فرق القفزات الإضافي دون أن يلتقطه | يثبّت أفضل سعر مرسوماً على دفتر الأوامر، فلا يكون سعر التنفيذ أسوأ من السعر النظري؛ وعندما يتجاوز انحراف السعر عن السعر النظري العتبة (الافتراضية ≈2× الرسوم) يبادر إلى التنفيذ النشط لتثبيت الربح الزائد؛ وعند السعر غير المواتي يُفصَل ويرفض الأمر |
| **توقيت بناء المركز** | فتح المركز فور دخول النطاق | بناء المركز بالتتبّع: عند الدخول في اتجاه الخسارة، يتتبّع القاع، ولا يبني المركز إلا بعد تأكيد الارتداد (الافتراضي 0.2%) |
...
الرسوم تجبيها البورصة، و**GridPilot لا يقتطع منها فلساً واحداً**. في الصفقة نفسها، أمر التعليق (Maker) ≈0.02%، وأمر التنفيذ النشط (Taker) ≈0.05%. أوامر الشبكة اليومية تمرّ عبر Maker (التعليق) لدى الطرفين، فلا فرق في رسوم تنفيذ الشبكة اليومي بينهما؛ إنما تتجلى ميزة GridPilot في ثلاث لحظات حاسمة — ① عند الدخول: ينتظر تأكيد الارتداد ثم يدخل بأمر معلّق، بدل فتح مركز سوق فوري لدى دخول النطاق؛ ② عند وقف الخسارة: يخفّض المركز تدريجياً بأوامر محددة خطوة خطوة، بدل تصفية سوق كاملة بنقرة واحدة؛ ③ عند التنفيذ النشط: لا يأذن بمسار Taker إلا حين يغطي فرق السعر الزائد الرسومَ فعلاً.
...
2. **تهيئة الشبكة**: اختر زوج التداول والاتجاه (شراء / بيع)، واضبط مرساة سعر جني الأرباح وعدد خطوط الشبكة الرئيسية وحجم الخطوة والكمية لكل خط والرافعة المالية ومخزن وقف الخسارة ومعاملات بناء المركز بالتتبّع (تُشتقّ حدود الصندوق تلقائياً من مرساة سعر جني الأرباح + عدد الخطوط وحجم الخطوة).
...
4. **المراقبة والإنهاء**: عند وصول السعر إلى جانب جني الأرباح، تُغلق الشبكة مراكزها خطوة خطوة في إنهاءٍ طبيعي، وبعد تصفير المركز يخرج بجني الأرباح؛ أما عند الهبوط إلى مخزن وقف الخسارة فيجري التخفيض الديناميكي خطوة خطوة.
...
| `direction` | الاتجاه: LONG (شراء) / SHORT (بيع) |
...
| `isolationStep` | عرض الحزام العازل (القيمة الافتراضية = حجم خطوة منطقة وقف الخسارة) |
| `activationPrice` / `trailingCallbackRate` | سعر تفعيل النطاق (الافتراضي: نقطة منتصف الشبكة الرئيسية) / نسبة ارتداد بناء المركز بالتتبّع |
